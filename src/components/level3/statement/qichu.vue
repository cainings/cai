    ...
    <div class="saixuan">
        ...
        <el-row class="biank">
            ...
            <el-col :span="5">
                ...
                <select v-model="cangkuNo" class="select2_padd">
                    <option value="0" selected>请选择</option>
                    <option v-for="(item, index) in cangkuList" :key="index" :value="item.id">{{item.cName}}</option>
                </select>
            </el-col>
            <el-col :span="5">
        ...
        <div class="biaoge">
            ...
            <el-table :data="tableData" style="width: 100%;" ref="multipleTable" :header-cell-style="{background:'#eef1f6',color:'#606266'}" :default-sort="{prop: 'date', order: 'descending'}" border label-class-name="bg-color_hui" :row-style="{'padding':'0'}">
                ...
                <el-table-column prop="name" label="产品编号"></el-table-column>
                ...
                <el-table-column prop="address" label="期初"></el-table-column>
                <el-table-column prop="address" label="入库"></el-table-column>
                <el-table-column prop="address" label="出库"></el-table-column>
                <el-table-column prop="address" label="期末"></el-table-column>
            </el-table>
