    ...
    <div class="saixuan">
        ...
        <div class="biaoge">
            ...
            <el-table :data="tableData" style="width: 100%;" ref="multipleTable" :header-cell-style="{background:'#eef1f6',color:'#606266'}" :default-sort="{prop: 'date', order: 'descending'}" border label-class-name="bg-color_hui" :row-style="{'padding':'0'}">
                ...
                <el-table-column prop="date" label="库存编号"></el-table-column>
                <el-table-column prop="address" label="库位名称"></el-table-column>
                <el-table-column prop="address" label="库位类型"></el-table-column>
                <el-table-column prop="address" label="仓库"></el-table-column>
                <el-table-column prop="address" label="库存数"></el-table-column>
            </el-table>
