...
<div>
    ...
    <div class="saixuan">
        ...
        <el-row class="biank">
            <el-col :span="5">
                <label class="color-hui">库位编号：</label>
                <input class="hei_30" type="text" placeholder="请输入" v-model="number" />
            </el-col>
            <el-col :span="5">
                <label class="color-hui">库位名称：</label>
                <input class="hei_30" type="text" placeholder="请输入" v-model="typeName" />
            </el-col>
            <el-col :span="5">
                <label class="color-hui">仓库：</label>
                <select v-model="ckId" class="select2_padd">
                    <option value="0" selected>请选择</option>
                    <option v-for="(item, index) in bumenList" :key="index" :value="index">{{item.stateName}}</option>
                </select>
            </el-col>
            <el-col :span="4">
        ...
        <div class="biaoge">
            ...
            <el-table :data="tableData" style="width: 100%;" ref="multipleTable" :header-cell-style="{background:'#eef1f6',color:'#606266'}" :default-sort="{prop: 'date', order: 'descending'}" border label-class-name="bg-color_hui" :row-style="{'padding':'0'}">
                ...
                <el-table-column width="50" label="库位编号"></el-table-column>
