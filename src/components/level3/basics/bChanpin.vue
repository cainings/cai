...
<div>
    ...
    <div class="saixuan">
        ...
        <el-row class="biank">
            <el-col :span="5">
                <label class="color-hui">产品编号:</label>
            ...
            <el-col :span="5">
                <label class="color-hui">类型：</label>
                <select v-model="leix" class="select2_padd">
                    <option value="0" selected>请选择</option>
                    <option v-for="(item, index) in leiList" :key="index" :value="item.id">{{item.leixName}}</option>
                </select>
            </el-col>
            <el-col :span="5">
                <label class="color-hui">电话：</label>
                <input class="hei_30" type="text" placeholder="请输入" v-model="typeName" />
            </el-col>
            <el-col :span="4">
        ...
        <div class="biaoge">
            ...
            <el-table :data="tableData" style="width: 100%;" ref="multipleTable" :header-cell-style="{background:'#eef1f6',color:'#606266'}" :default-sort="{prop: 'date', order: 'descending'}" border label-class-name="bg-color_hui" :row-style="{'padding':'0'}">
                ...
                <el-table-column prop="address" label="厂商编号"></el-table-column>
                <el-table-column prop="address" label="内部编码"></el-table-column>
                <el-table-column prop="address" label="规格"></el-table-column>
                <el-table-column prop="address" label="类别"></el-table-column>
                <el-table-column prop="address" label="存储单位"></el-table-column>
                <el-table-column prop="address" label="预警（下）"></el-table-column>
                <el-table-column prop="address" label="预警（上）"></el-table-column>
                <el-table-column prop="address" label="包装类型"></el-table-column>
                <el-table-column prop="address" label="价格"></el-table-column>
                <el-table-column prop="address" label="重量"></el-table-column>
                <el-table-column prop="address" label="默认供应商"></el-table-column>
