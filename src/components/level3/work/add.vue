    ...
    <div class="z">
      ...
      <div class="zz">
        <div class="e">
          <div class="e-1">
            <p>入库单号：</p>
            <input type="text" placeholder="可不填写，自动生成" readonly />
          </div>
          <div class="e-2">
            <p>
              <span style="color:red;">*</span>供应商编号
            </p>
            <input type="text" placeholder="双击进行选择" readonly @dblclick="sj()" />
          </div>
          <div class="e-3">
            <p>
        ...
        <div class="r">
          <div class="r-1">
            ...
            <input type="text" placeholder="请选择入库类别" />
          </div>
          <div class="r-2">
            <p>
          ...
          <div class="r-3">
            <p>制单人</p>
            <input type="text" placeholder="张丽" readonly />
          </div>
        </div>
        <div class="w">
          <div class="w-1">
          ...
          <div class="w-3">
            <p>制单时间</p>
            <input type="text" :value="shijian | guolv" readonly />
          </div>
        </div>
      </div>
      <div class="t">
