    ...
    <div class="saixuan">
        ...
        <div class="biaoge">
            ...
            <el-table :data="tableData" style="width: 100%;" ref="multipleTable" :header-cell-style="{background:'#eef1f6',color:'#606266'}" :default-sort="{prop: 'date', order: 'descending'}" border label-class-name="bg-color_hui" :row-style="{'padding':'0'}">
                ...
                <el-table-column prop="sx" label="上限"></el-table-column>
                <el-table-column prop="xx" label="下限"></el-table-column>
                <el-table-column prop="kcs" label="库存数"></el-table-column>
            </el-table>
...
export default {
    ...
    created() {
        get('kcyujing').then((res) => {
            this.tableData = res.data.yujing
        })
    },
};
</script>
