<template>
  <div>
    ...
    <div class="saixuan">
      ...
      <el-row class="biank">
        <el-col :span="6">
          <label class="color-hui">盘点单号：</label>
      ...
      <div class="biaoge">
        ...
        >
          ...
          <el-table-column prop="pddh" label="盘点单号"></el-table-column>
          <el-table-column prop="pdlx" label="盘点类型"></el-table-column>
          <el-table-column prop="gldh" label="关联单号" width="105"></el-table-column>
          ...
          <el-table-column label="操作" width="150">
            <template slot-scope="scope">
              ...
              <el-button
                @click.native.prevent="shangchuan(scope.$index, tableData)"
                type="text"
                size="small"
              >
                <i class="el-icon-folder-add"></i>上传
              </el-button>
            </template>
          </el-table-column>
        </el-table>
...
export default {
  ...
  created() {
    get("pandian").then(res => {
      this.tableData = res.data.pandian;
    });
  }
};
</script>
