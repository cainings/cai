    ...
    <div class="saixuan">
        ...
        <el-row class="biank">
            ...
            <el-col :span="5">
                ...
                <input class="hei_30" type="text" placeholder="请输入" v-model="pici" />
            </el-col>
            <el-col :span="4">
        ...
        <div class="biaoge">
            ...
            <el-table :data="tableData" style="width: 100%;" ref="multipleTable" :header-cell-style="{background:'#eef1f6',color:'#606266'}" :default-sort="{prop: 'date', order: 'descending'}" border label-class-name="bg-color_hui" :row-style="{'padding':'0'}">
                ...
                <el-table-column prop="ccdw" label="存储单位"></el-table-column>
                <el-table-column prop="ck" label="仓库"></el-table-column>
                <el-table-column prop="kw" label="库位"></el-table-column>
            </el-table>
...
export default {
    ...
    created() {
        get('kcqingdan').then((res) => {
            this.tableData = res.data.qingdan
        })
    },
};
</script>
