<template>
  <div>
    ...
    <div class="saixuan">
      ...
      <el-row class="biank">
        <el-col :span="6">
          <label class="color-hui">入库单号：</label>
        ...
        <el-col :span="6">
          <label class="color-hui">入库状态：</label>
      ...
      <div class="biaoge">
        <el-row class="title_bg">
          ...
          <el-col :span="12" :offset="9">
            ...
            <el-button icon="el-icon-folder" @click="exportExcel">导出</el-button>
          </el-col>
        </el-row>
        <el-table
          id="out-table"
        ...
        >
          ...
          <el-table-column prop="rklx" sortable label="入库类型" width="105"></el-table-column>
          <el-table-column prop="gys" sortable label="供应商" width="105"></el-table-column>
          ...
          <el-table-column label="操作" width="150">
            <template slot-scope="scope">
              <el-button
                @click.native.prevent="selectROw(scope.$index, tableData)"
                type="text"
                size="small"
              >
              ...
              <el-button
                @click.native.prevent="updaeRow(scope.$index, tableData)"
                type="text"
                size="small"
              >
...
export default {
  ...
  methods: {
    ...
    updaeRow(index, rows) {
            ...
            let xg={
                 ddh:rows[index].ddh,
                cpbh:rows[index].cpbh,
                pc:rows[index].pc,
                gg:rows[index].gg,
                sl:rows[index].sl,
                kw:rows[index].kw,
                rklx:rows[index].rklx,
                gys:rows[index].gys,
                shsj:rows[index].shsj,
                bz:rows[index].bz
            }
            this.$router.push({
                name:'update',
  ...
  created() {
    get("ruku").then(res => {
      ...
      let ddh = this.$route.params.items;
      if (ddh != null) {
        this.tableData.unshift(ddh);
      }
    });
  }
};
