...
<div>
    ...
    <div class="saixuan">
        ...
        <el-row class="biank">
            <el-col :span="5">
                <label class="color-hui">采购单号：</label>
        ...
        <div class="biaoge">
            ...
            <el-table :data="tableData" style="width: 100%;" ref="multipleTable" :header-cell-style="{background:'#eef1f6',color:'#606266'}" :default-sort="{prop: 'date', order: 'descending'}" border label-class-name="bg-color_hui" :row-style="{'padding':'0'}">
                ...
                <el-table-column prop="th" label="退货"></el-table-column>
        ...
        <div class="all">
            <div class="small">
                ...
                <div class="a-3">
                    ...
                    <div class="a-2-2">
                        <p>供应商名称：</p>
                        <input type="text" placeholder="请输入/扫描单号" v-model="a5_input" />
                    </div>
                </div>
            </div>
            <div class="foot flex">
...
export default {
    ...
    created() {
        get('ywcaigou').then((res) => {
            this.tableData = res.data.caigou
        })
    },
};
</script>
