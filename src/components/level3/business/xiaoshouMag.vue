    ...
    <div class="saixuan">
        ...
        <div class="biaoge">
            ...
            <el-table :data="tableData" style="width: 100%;" ref="multipleTable" :header-cell-style="{background:'#eef1f6',color:'#606266'}" :default-sort="{prop: 'date', order: 'descending'}" border label-class-name="bg-color_hui" :row-style="{'padding':'0'}">
                ...
                <el-table-column prop="cks" label="出库数"></el-table-column>
                <el-table-column prop="khdh" label="客户单号"></el-table-column>
                <el-table-column prop="khbh" label="客户编号"></el-table-column>
                <el-table-column prop="khm" label="客户名"></el-table-column>
                <el-table-column prop="ddze" label="订单总额"></el-table-column>
                <el-table-column prop="zt" label="状态"></el-table-column>
                <el-table-column prop="sfrz" label="是否入账"></el-table-column>
            </el-table>
        ...
        <div class="all">
            <div class="small">
                ...
                <div class="a-3">
                    <div class="a-2-1">
                        <p>产品编号：</p>
                        <input type="text" v-model="a4_input" />
                    </div>
                    <div class="a-2-2">
                        <p>客户编号：</p>
...
export default {
    ...
    created() {
        get('ywxiaoshou').then((res) => {
            this.tableData = res.data.xiaoshou
        })
    },
};
</script>
