...
<div>
    ...
    <div class="saixuan">
        ...
        <el-row class="biank">
            <el-col :span="6">
                <label class="color-hui">报损单号：</label>
        ...
        <div class="biaoge">
            ...
            <el-table :data="tableData" style="width: 100%;" ref="multipleTable" :header-cell-style="{background:'#eef1f6',color:'#606266'}" :default-sort="{prop: 'date', order: 'descending'}" border label-class-name="bg-color_hui" :row-style="{'padding':'0'}">
                ...
                <el-table-column prop="ddh" label="报损单号"></el-table-column>
                ...
                <el-table-column prop="kw" label="仓库"></el-table-column>
                <el-table-column prop="kw" label="原库位"></el-table-column>
                <el-table-column prop="kw" label="报损库位"></el-table-column>
                <el-table-column prop="rklx" label="报损类型"></el-table-column>
                ...
                <el-table-column label="操作" width="150">
                    <template slot-scope="scope">
                        ...
                        <el-button @click.native.prevent="shenhe(scope.$index, tableData)" type="text" size="small">
